import heapq
import time
from A_star_search_testcase import simulate_path
...
graph = {
    ...
    "Mahikeng": ["Mmabatho", "Slurry", "Bakerville", "Madibogo"],
    "Mmabatho": ["Mahikeng", "Slurry"],
    "Slurry": ["Bakerville", "Mahikeng", "Zeerust", "Groot Marico"],
    "Zeerust": ["Groot Marico", "Slurry"],
    "Groot Marico": ["Zeerust", "Slurry"],
    "Bakerville": ["Lichtenburg", "Slurry", "Mahikeng"],
    "Lichtenburg": ["Bakerville", "Coligny"],
    "Coligny": ["Ottosdal", "Lichtenburg"],
    "Ottosdal": ["Sannieshof", "Coligny"],
    "Sannieshof": ["Delareyville", "Madibogo", "Ottosdal"],
    "Delareyville": ["Sannieshof"],
    "Madibogo": ["Disaneng", "Sannieshof", "Mahikeng"]
